...
def add_arguments(parser):
    ...
    parser.add_argument("--return_type", action='store_true',
                        help='Whether to do per-type evaluation')

    parser.add_argument("--topk", type=int, default=1)

    parser.add_argument("--test_example_begin", type=int, default=0)
    parser.add_argument("--test_example_end", type=int, default=-1)
